...
describe("Navigation", () => {
  ...
  it('deve rendrizar os textos traduzidos nos links desktop', () => {
    render(<Navigation/>)
    expect(screen.getByTestId('nav-link-desktop-hero')).toHaveTextContent('Início')
    expect(screen.getByTestId('nav-link-desktop-projects')).toHaveTextContent('Projetos')
    expect(screen.getByTestId('nav-link-desktop-skills')).toHaveTextContent('Skills')
    expect(screen.getByTestId('nav-link-desktop-about')).toHaveTextContent('Sobre')
    expect(screen.getByTestId('nav-link-desktop-contact')).toHaveTextContent('Contato')
  })

  it('deve ter os hrefs corretos nos links html', () => {
    render(<Navigation/>)
    expect(screen.getByTestId('nav-link-desktop-hero')).toHaveAttribute('href', '#hero')
    expect(screen.getByTestId('nav-link-desktop-projects')).toHaveAttribute('href', '#projects')
    expect(screen.getByTestId('nav-link-desktop-skills')).toHaveAttribute('href', '#skills')
    expect(screen.getByTestId('nav-link-desktop-about')).toHaveAttribute('href', '#about')
    expect(screen.getByTestId('nav-link-desktop-contact')).toHaveAttribute('href', '#contact')
  })
